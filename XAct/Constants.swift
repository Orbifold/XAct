...
public struct Constants
{
    ...
    */
    ...
    public static let E = 2.7182818284590452353602874713526624977572470937000;
    ...
    public static let InverseE = 0.36787944117144232159552377016146086744581113103176;
    ...
    This one has a higher precision than the system one.  */
